...
const RequireAuth = ({ allowedRoles }) => {
  ...
  // if allowedRoles includes one of the roles that the user has then true
  const content = roles.some((role) => allowedRoles.includes(role)) ? (
    ...
    // they will be navigated to /login, but the back button will be to prev page, and not the route thye tried
